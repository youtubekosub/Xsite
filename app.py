...
def index():
    ...
    results = []
    if query:
        # デモ用データ。実際にはここで検索APIを叩く。
        mock_data = [
            {"title": f"{query} - 匿名検索結果 1", "url": f"https://www.google.com/search?q={query}", "desc": "HMAC署名によって保護された、プライバシー重視の検索結果です。"},
            {"title": "Wikipedia: プライバシーについて", "url": "https://ja.wikipedia.org/wiki/プライバシー", "desc": "個人の私生活上の事柄をみだりに公開されない法的権利についての解説。"},
            {"title": "GitHub: Open Source Projects", "url": "https://github.com", "desc": "ソースコードのホスティングとプライベートな開発が可能なプラットフォーム。"}
        ]
